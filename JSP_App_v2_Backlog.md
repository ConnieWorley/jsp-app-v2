...
- [ ] Setup is considered complete when all required sections are finished: Ideal Company Quiz, Role Target Profile, Resume Library (min. 1), and Storybank (min. 1 story)
...
- [ ] Each checklist item can be assigned a due date
...
- [ ] Completed checklist items are removed from the action list automatically
...
---
*Backlog complete — v2 scope fully documented.*